    ...
    <section className={styles.employmentHistory}>
        ...
        <div>
            <article>
                ...
                <ul>
                    <li>
                        Actively contributed in a team to develop a healthcare
                        data platform for a major client.
                    </li>
                    <li>
                        Wrote high quality Rails and React code to build and
                        update features in multiple Neeto products.
                    </li>
                    <li>
                        Worked in setting up GitHub actions and clearing bugs
                        for neeto-ui (open source package).
                    </li>
                    <li>
                        Worked on migrating{" "}
                        <a
                    ...
                    <li>
                        ...
                        applications using Rails, React, Tailwind and
                        PostgreSQL.
                    </li>
                </ul>
            </article>
            ...
            <article>
                ...
                <ul>
                    ...
                    <li>
                        Added features and fixed bugs for a drop shipping site
                        that worked by displaying Amazon products with
                        recalculated price and details.
                    </li>
                </ul>
            </article>
            ...
            <article>
                ...
                <ul>
                    ...
                    <li>
                        Created, organized and documented a client relations
                        system.
                    </li>
                    <li>
                        Organized and documented an adaptive task-management
                        system.
                    </li>
                </ul>
            </article>
